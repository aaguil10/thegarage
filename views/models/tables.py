...
db.define_table('items',
               ...
               # Field('item_owner', db.auth_user, default=auth.user_id),
                ...
                Field('item_state', 'integer',default=1), # 1 = Avalible, 2 = peddnig confermation, 3 = being borrowed
                Field('requestArray', 'string') #not implemented yet put this is where u would store list of users that want to borrow
